...
public class Enemy extends Sprite{
	...
	public Enemy(ITextureRegion pTextureRegion, int childCount, float x, float y, int health, float speed, Integer worth) {
	...
	private void dropChildren() {
		if (path != null && this.getClass() != GruntEnemy.class) {
