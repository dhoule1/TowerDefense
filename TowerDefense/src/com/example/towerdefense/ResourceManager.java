...
public class ResourceManager {
	...
	private TextureRegion redFlameEnemyRegion;
	private TextureRegion blueFlameEnemyRegion;
	...
	private void loadGameGraphics() {
		...
		//ENEMIES
		redFlameEnemyRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, activity, "red_flame_enemy.png"); //14x27
		blueFlameEnemyRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, activity, "blue_flame_enemy.png"); //14x27
		...
		//TOWERS
		turretTowerRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, activity, "turret.png"); //80x80
	...
	public TextureRegion getRedFlameEnemyRegion() {
		return redFlameEnemyRegion;
	}

	public void setRedFlameEnemyRegion(TextureRegion redFlameEnemyRegion) {
		this.redFlameEnemyRegion = redFlameEnemyRegion;
	}

	public TextureRegion getBlueFlameEnemyRegion() {
		return blueFlameEnemyRegion;
	}

	public void setBlueFlameEnemyRegion(TextureRegion blueFlameEnemyRegion) {
		this.blueFlameEnemyRegion = blueFlameEnemyRegion;
	}
	...
	public void setTurretTowerRegion(TextureRegion turretTowerRegion) {
